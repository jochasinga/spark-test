...
ESC.prototype.speed = function(speed) {
  ...
  if (steps === 1) {
    this.speed.send.call(this, speed);
  } else {

    this.interval = setInterval(function tick() {
      ...
      this.speed.send.call(this, throttle);

  // this.io.servoWrite(
  //   this.pin, (speed * 180 / 100)
  // );
...
ESC.prototype.speed.send = function(speed) {
  this.io.servoWrite(
    this.pin, (speed * 180 / 100)
  );

  priv.get(this).history.push({
    timestamp: Date.now(),
    speed: speed
  });
};
