 ...
 *
 * 0 Full speed A
 * center - 1 Slowest speed A
 * 90 Stopped
 * center + 1 Slowest speed B
 * 180 Fastest speed B
 *
 *
 **/
...
[{
  ...
  setup.apis.forEach(function(api) {
    Servo.prototype[api] = function(rate) {
      var center = (this.range[0] + this.range[1]) / 2 | 0;
      var ranges = api === "cw" ?
        [0, 1, center, this.range[1]] :
        [0, 1, center, this.range[0]];
      ...
      ranges.unshift(rate);
      return this.to(__.scale.apply(null, ranges) | 0);
    };
  });
});
